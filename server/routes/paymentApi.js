...
const stripe = require("stripe")(
  "sk_test_51JWO03SCs6XIxvmir7XV3fxUppYZj7Qn5ZWf7LbfRxhfR1mUI5FQnV5cichoBrCd1v5CqNgrA5hS05GCTZR1GG6E00Sw4A5icj"
);
    ...
    stripe.charges.create(
      {
        ...
        description: `Payment for the purchase of ${cart.products.length} items form OneSpot`,
      },
      async (err, charge) => {
        if (err) {
